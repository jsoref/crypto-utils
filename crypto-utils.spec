...
%changelog
* Sun Oct 04 2009 Elio Maldonado<emaldona@redhat.com> - 2.4.1-25
- Bumping the release number to avoid tag conflicts with other branches
...
* Fri Feb 26 2009 Elio Maldonado <emaldona@redhat.com> - 2.4.1-16
...
- certwatch: Fixed cert expiry time calculations (#473860)
- keyutil: Fixed segfault on certificate generation (#479886)
- keyutil: Fixed logic error that prevented ouput of pem key file

* Thu Jan 30 2009 Elio Maldonado <emaldona@redhat.com> - 2.4.1-10
- certwatch: Fixed cert expiry time calculations (#473860)
- keyutil: Fixed segfault on certificate generation (#479886)
- genkey: Fixed cert and key file name extensions
